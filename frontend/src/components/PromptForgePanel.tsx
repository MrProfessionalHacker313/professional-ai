...
export default function PromptForgePanel({ onClose }: PromptForgePanelProps) {
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-white">Prompt Forge</h3>
            <p className="text-xs text-gray-400">Generate prompts that any AI will execute</p>
          </div>
        </div>
